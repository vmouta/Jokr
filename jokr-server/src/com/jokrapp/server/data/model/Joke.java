...
public class Joke {
	...
	private String tags;
	private int likes;
	private String language; // ISO 639-1 codes (en, de, fr) and "sde" swiss
								// german see
	...
	public Joke(String _id, String title, String tags, int likes,
	...
	public String toString() {
		return "Joke [_id=" + _id + ", _rev=" + _rev + ", title=" + title
				+ ", tags=" + tags + ", likes=" + likes + ", language="
				+ language + ", isPublic=" + isPublic + ", framingBegin="
				+ framingBegin + ", framingEnd=" + framingEnd
				+ ", creationTimestamp=" + creationTimestamp
				+ ", uploadTimestamp=" + uploadTimestamp + ", objectClass="
				+ objectClass + ", userName=" + userName + ", userId=" + userId
